...
class CronConfig
{
    public static $config = [
        ...
        'reddit_clientId' =>'AvHFVXLnCNEiDqta8SZOBg',
        'reddit_clientSecret' =>'m1twWaVwsbtVcQa_2YHPonc8MuMEbg',
        'reddit_userAgent' =>'theotokatosboxing/0.1',
        'reddit_username' =>'theotokatosboxing',
        'reddit_password' =>'ethe526996####',
    ];
}
